...
def format_relative_time(value, now=None):
    ...
    e.g. "Updated 2 hours ago". Mirrors app/page.tsx's formatLastSeen so
    the frontend and the notification digest describe listing freshness
    the same way. Returns None when `value` is missing/unparseable.
    """
