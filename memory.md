...
migrations/           Run manually in the Supabase SQL editor -- nothing here applies itself
  ...
  012  drops the table-wide unique constraint on listings.original_url, adds a plain non-unique index -- looks the constraint up by definition (learning from 007's wrong-name guess) rather than guessing its name; not yet run as of this writing, see original_url decision below
